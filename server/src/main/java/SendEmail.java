...
public class SendEmail
{
	public static void main(String [] args){
		String to = "test@fizzle.email";//change accordingly
		String from = "example@email.com";//change accordingly
		...
		for (int i=0; i<1; i++) {
			...
			try {
				...
				message.setSubject("Welcome " + i);

				BodyPart messageBodyPart = new MimeBodyPart();
				messageBodyPart.setText("Hello, this is example of mail with > and < and \" and & sending \nnewline email.");
